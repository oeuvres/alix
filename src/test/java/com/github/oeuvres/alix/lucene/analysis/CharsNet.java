...
public class CharsNet
{
    ...
    /** Dictionary of nodes */
    private HashMap<CharsAttImpl, Node> nodeHash = new HashMap<CharsAttImpl, Node>();
    /** Node index by id */
    ...
    public void inc(final CharsAttImpl token)
    {
        inc(token, 0);
    }

    public void inc(final CharsAttImpl token, final int tag)
    {
        Node pivot = nodeHash.get(token);
        if (pivot == null) {
            CharsAttImpl key = new CharsAttImpl(token);
    ...
    public class Node
    {
        ...
        /** persistent label */
        private final CharsAttImpl label;
        ...
        public Node(final CharsAttImpl label, final int tag) {
            this.label = new CharsAttImpl(label);
            this.tag = tag;
    ...
    public Node node(final CharsAttImpl token)
    {
