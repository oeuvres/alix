...
public class TermList implements Iterable<Term>
{
    ...
    /**
     * Add a term to the series, handle a null label as a group separator, get term
     * frequence to strip unknown search, and sort in inverse frequency.
     * 
     * @param term
     */
    ...
    /**
     * Output list of search as a collection of bytes reference suited for Lucene
     * automaton.
     * 
     * @return
     */
    ...
    private class Cursor implements Iterator<Term>
    {
        ...
        private Cursor() {
            this.size = data.size();
            // System.arraycopy will bug on null elements, avoid data.toArray(new
            // Term[size]);
