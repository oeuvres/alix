 ...
 * <p>
 * A single {@code long[]} holds all entries. Each occupied slot packs one
 * (key, value) pair:
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * The sentinel {@code 0L} marks an empty slot, which means the real key
 * {@code 0} cannot be packed there. It is stored out-of-band via
 * {@link #hasZeroKey} / {@link #zeroValue}.
 * </p>
 *
 * <h2>Missing-value contract</h2>
 * <p>
 * Every query method returns {@link #missingValue()} when a key is absent.
 ...
 * <em>before</em> any state mutation.
 * </p>
 *
 * <h2>Limitations</h2>
 * <ul>
...
public final class IntIntMap
{
     ...
     *
     * <p>
     * The resulting value must not equal {@link #missingValue()};
     ...
     *
     * <p>
     * Intended for bulk-load scenarios where duplicate keys indicate a bug
     * in the caller.
     * </p>
     *
     * @param key   any int key
