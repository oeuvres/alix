 ...
 * 
 */
public class _OldAlixDocument
{
    /** logger */
    private static Logger LOGGER = LoggerFactory.getLogger(_OldAlixDocument.class);
     ...
     */
    public _OldAlixDocument(final String[] required) {
     ...
     */
    public _OldAlixDocument id(final String id)
    {
        if (bad(id)) {
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument title(String html)
    {
        catField("title", html);
        return this;
    }
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument byline(String html)
    {
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument year(int year)
    {
        intField("year", year);
        return this;
    }
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument author(String html)
    {
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument bibl(String html)
    {
        metaField("bibl", html);
        return this;
    }
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument catField(String name, String html)
    {
        if (bad(html))
            return this;
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument facetField(String name, String html)
    {
        if (bad(html))
            return this;
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument metaField(String name, String html)
    {
        if (bad(html))
            return this;
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument intField(final String name, final int value)
    {
        if (uniks.contains(name)) {
            return this;
        }
     ...
     * @return This for chaining.
     */
    public _OldAlixDocument textField(final String html)
    {
