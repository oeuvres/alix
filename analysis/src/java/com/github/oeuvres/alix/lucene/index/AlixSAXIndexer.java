...
public class AlixSAXIndexer extends DefaultHandler
{
        ...
        if (FIELD.equals(localName) && record) {
            ...
            try {
                ...
                case TEXT:
                    ...
                    doc.add(new Field(name, text, AlixWriter.ftypeText));
                    doc.add(new Field(name + "_cloud", text, AlixWriter.ftypeText)); // indexation of the chosen tokens
                    doc.add(new Field(name + "_orth", text, AlixWriter.ftypeText)); // indexation of the chosen tokens
                    break;
                default:
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        // open a field
            ...
            case META:
                if (value != null) {
                    doc.add(new Field(name, value, AlixWriter.ftypeMeta));
                } else {
                    fieldName = name;
                    record = true;
                    this.type = META;
