...
public final class WordsAutomatonBuilder {
  ...
  public void add(String current) {
    ...
    if (max > MAX_TERM_LENGTH) {
      throw new IllegalArgumentException("This builder doesn't allow terms that are larger than "+MAX_TERM_LENGTH+" characters, got " + current);
    }
  ...
  /**
   * Build an automaton from a list of strings,
