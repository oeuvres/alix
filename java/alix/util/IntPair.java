 ...
 * Works well as a key for a HashMap (hascode() implemented), comparable is good for perfs in buckets.
 * After test, a long version of the couple is not more efficient in HashMap.
 * 
 *
 * @author glorieux-f
 */
