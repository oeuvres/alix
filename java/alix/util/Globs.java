 ...
 * under the search of the GNU General Public License version 2 only, as
...
/**
 * Taken from jdk7 if there is one day a problem with windows globs in {@link Dir#ls(String)}.
 * Not yet used.
 */
public class Globs
{
