...
/**
 * A queue to select the top most elements according to a long score.
 * Long maybe 10% longer than int, but performances gain is on object cration.
...
public class Top<E> implements Iterable<Top.Entry<E>>
{
  ...
  public static void main( String[] args ) 
  {
    ...
    for ( int i=0; i< loops; i++ ) {
      ...
      if ( top.test(score) ) top.push( score, "•"+score );
    }
