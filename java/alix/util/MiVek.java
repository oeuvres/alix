 ...
 * Be careful, key uniqueness is not tested, should be done before
 * Mapping between keys is obtained by sorting the keys.
 * @author glorieux-f
 *
 */
public class MiVek {
  ...
  public static void main(String[] args)
  {
    ...
    for ( int i=0; i < max; i++ ) list[i] = new MiVek();
    ...
    /*
    list[2].push( 1, 2.5 ).push( 2, 2.5 ).sortByKey();
    list[3].push( 1, 0.5 ).push( 2, 0.5 ).push( 3, 0.5 ).sortByKey();
    */
