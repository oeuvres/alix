 ...
 * @param <T>
 */
public class TermSlider extends Slider {
   ...
   */
  public TermSlider(final int left, final int right) 
  {
    super(left, right);
    data = new Term[width];
  ...
  public Term next()
  {
    data[pointer(-left)].clear(); // clear the last term to find it as first one
    center = pointer( +1 );
    return data[center];
  }
  /**
  ...
  public static void main(String args[]) 
  {
    String text = "Son amant emmène un jour O se promener dans un quartier où"
      + " ils ne vont jamais."
    ;
    TermSlider win = new TermSlider(2, 5);
