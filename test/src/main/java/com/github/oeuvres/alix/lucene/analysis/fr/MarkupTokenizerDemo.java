...
public class MarkupTokenizerDemo
{
    ...
    static final List<Case> CASES = List.of(
            ...
            new Case("Em dash separators", "— et personne ne songe à en nier la nécessité —",
                    "Dash should be punctuation token(s); check spaces around."),

            new Case("Numbers + decimal separators + trailing punctuation",
                    "3,14 2.718 12, 12. 1,234 1.234 99... fin",
                    "Ensure trailing '.'/',' after a number becomes punctuation, not part of number."),

            new Case("Sentence punct adjacency", "Hello!World What?!No ... …?!",
                    "Ensure '!World' does not occur; sentence punct runs should not absorb letters."),

            new Case("Tags + entities", "<a href=\"x&y\">A&amp;B</a> &lt;p&gt;Texte&lt;/p&gt;",
                    "Check XML tokenization and decoding of &amp; / &lt; / &gt;."),

            new Case("Broken/truncated tag (EOF)", "<a href=\"x\" Texte",
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        switch (which) {
            case "orig" -> {
                Analyzer a = AnalyzerFactory.forTokenizer(() -> new MarkupTokenizer(FrenchLexicons.buildBrevidots()));
