    ...
    private static Analyzer buildAnalyzer(final POSModel model) throws IOException {
        ...
        return new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName) {
                ...
                String names = """
                    Émile Meyerson,Meyerson Émile,NamePers
                    Emile Meyerson,Meyerson Émile,NamePers
                    É. Meyerson,Meyerson Émile,NamePers
                    E. Meyerson,Meyerson Émile,NamePers
                    Ignace Meyerson,Meyerson Ignace,NamePers
                    I. Meyerson,Meyerson Ignace,NamePers
                    I Meyerson,Meyerson Ignace,NamePers
                """;
