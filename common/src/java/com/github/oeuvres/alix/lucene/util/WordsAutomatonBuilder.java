 ...
 * strings. The algorithm requires sorted input data, but is very fast (nearly
...
public final class WordsAutomatonBuilder
{
    ...
    private final static class State
    {
        ...
        /**
         * <code>true</code> if this state corresponds to the end of at least one input
         * sequence.
         */
        boolean is_final;
         ...
         * <ul>
         * <li>they have an identical number of outgoing transitions, labeled with the
         * same labels</li>
    ...
    public void add(String current)
    {
        ...
        if (max > MAX_TERM_LENGTH) {
            throw new IllegalArgumentException("This builder doesn't allow terms that are larger than "
                    + MAX_TERM_LENGTH + " characters, got " + current);
        }
