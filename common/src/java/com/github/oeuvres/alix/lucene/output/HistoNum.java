...
public final class HistoNum {
	 ...
	 */
	public void addSnippets(final int docId, final int count)
	{
	...
	{
		if (valueSnippets != null) return valueSnippets;
	 ...
	 */
	public HistoNum(final int min, final int max, final int[] docValues, final FixedBitSet docHasValue,
